...
func (w *WriteBatch) Put(key, value []byte) {
	// rocketdb_writebatch_put, and _delete call memcpy() (by way of
	...
	C.rocketdb_writebatch_put(w.wbatch, k, C.size_t(lenk), v, C.size_t(lenv))
}
