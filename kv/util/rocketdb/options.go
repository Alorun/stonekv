...
func (o *Options) SetComparator(cmp *C.rocketdb_comparator_t) {
	C.rocketdb_options_set_comparator(o.Opt, cmp)
}
...
func (o *Options) SetErrorIfExists(error_if_exists bool) {
	...
	C.rocketdb_options_set_error_if_exists(o.Opt, eie)
}
...
func (o *Options) SetCache(cache *Cache) {
	C.rocketdb_options_set_cache(o.Opt, cache.Cache)
}

// SetEnv sets the Env object for the new database handle.
func (o *Options) SetEnv(env *Env) {
	C.rocketdb_options_set_env(o.Opt, env.Env)
}

// SetInfoLog sets a *C.rocketdb_logger_t object as the informational logger
// for the database.
func (o *Options) SetInfoLog(log *C.rocketdb_logger_t) {
	C.rocketdb_options_set_info_log(o.Opt, log)
}
...
func (o *Options) SetWriteBufferSize(s int) {
	C.rocketdb_options_set_write_buffer_size(o.Opt, C.size_t(s))
}
...
// detects errors.
//
// See the RocketDB documentation docs for details.
func (o *Options) SetParanoidChecks(pc bool) {
	C.rocketdb_options_set_paranoid_checks(o.Opt, boolToUchar(pc))
}

// SetMaxOpenFiles sets the number of files than can be used at once by the
// database.
//
// See the RocketDB documentation for details.
func (o *Options) SetMaxOpenFiles(n int) {
	C.rocketdb_options_set_max_open_files(o.Opt, C.int(n))
}
...
// your use case. See the RocketDB documentation for details.
func (o *Options) SetBlockSize(s int) {
	C.rocketdb_options_set_block_size(o.Opt, C.size_t(s))
}

// SetBlockRestartInterval is the number of keys between restarts points for
// delta encoding keys.
//
// Most clients should leave this parameter alone. See the RocketDB
// documentation for details.
func (o *Options) SetBlockRestartInterval(n int) {
	C.rocketdb_options_set_block_restart_interval(o.Opt, C.int(n))
}
...
func (ro *ReadOptions) SetFillCache(b bool) {
	C.rocketdb_readoptions_set_fill_cache(ro.Opt, boolToUchar(b))
}
...
func (ro *ReadOptions) SetSnapshot(snap *Snapshot) {
	var s *C.rocketdb_snapshot_t
	if snap != nil {
		s = snap.snap
	}
	C.rocketdb_readoptions_set_snapshot(ro.Opt, s)
}

// Close deallocates the WriteOptions, freeing its underlying C struct.
func (wo *WriteOptions) Close() {
	C.rocketdb_writeoptions_destroy(wo.Opt)
}
...
func (wo *WriteOptions) SetSync(b bool) {
	C.rocketdb_writeoptions_set_sync(wo.Opt, boolToUchar(b))
}
